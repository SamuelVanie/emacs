...
#+begin_src emacs-lisp
  (use-package bpsline
    :straight (bpsline :type git :host codeberg :repo "Sshigeru/bpsline" :branch "main")
    :config
    (bpsline-mode))
#+end_src
...
A tool that help moving things around in emacs. Lines, words, region...
...
#+begin_src emacs-lisp
  ...
  ;; Use the ls from homebrew for directory listing
  ;; would be /opt/homebrew/bin/gls for normal homebrew installation
...
Use multiple lsp servers in eglot using rassumfrassum

#+begin_src emacs-lisp
  (use-package eglot-multi-preset
    :straight (:type git :host github :repo "kn66/eglot-multi-preset" :files ("*.el"))
    :config
...
#+begin_src emacs-lisp
  (use-package gptel-agent
    ...
    :config
    (add-to-list 'gptel-agent-skill-dirs ".github/skills")
    (add-to-list 'gptel-agent-skill-dirs "~/.copilot/skills")
