...
On macos you should also install =mac-app-frontmost= then, if the window if not correctly placed inside the emacs frame, just move the frame with the mouse it will be replaced.
