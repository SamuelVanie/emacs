...
**** Project conf to permit eglot recognize project folder

You can now just add a .project.el file inside any folder and eglot and project.el will recognize this folder as the project root
