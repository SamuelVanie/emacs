...
(custom-set-variables
 ...
 '(package-selected-packages
   '(counsel-projectile projectile forge magit evil-nerd-commenter which-key visual-fill-column use-package rainbow-delimiters org-bullets olivetti no-littering ivy-rich ivy-prescient hydra helpful general evil-collection doom-themes doom-modeline counsel command-log-mode auto-package-update all-the-icons)))
(custom-set-faces
